...
"""
Identifies the boundary buses and external buses in the power system based on the provided internal buses. The function evaluates connections to determine which buses are considered boundary buses and which are external buses.

# Arguments
- `internal_buses::Vector{Int}:
        Vector containing the indices of the internal buses within the system.
- `all_lines::Vector{ACBranch}:
        Matrix representing all the branches in the system

# Returns
- `boundary_buses::Vector{Int}:
        Vector containing the indices of the boundary buses that are directly connected to the internal buses.
- `external_buses::Vector{Int}:
        Vector containing the indices of the external buses that are not part of the internal or boundary buses.
"""
